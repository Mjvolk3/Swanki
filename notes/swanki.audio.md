...
## 2026.05.17 - Export regenerate_and_restitch

`__init__.py` now also exports `regenerate_and_restitch` from the new
[[swanki.audio.surgical]] module (reusable surgical single-chunk re-TTS +
restitch), alongside `restitch_from_chunks`
